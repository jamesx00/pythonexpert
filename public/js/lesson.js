 ...
 * @typedef {import('./index.js').MonacoFileId} MonacoFileId
 * @typedef {import('/index.js').MonacoFileGroupId} MonacoFileGroupId
 */
...
require(["vs/editor/editor.main"], function () {
	...
	const multipleFileGroupEditor = new MultipleFileGroupEditor("#editor", {
	...
	function checkExerciseOutput(element, output) {
		...
		if (!checkExerciseWithJson) {
			...
			const isPassingTests =
				output.run.signal !== "SIGKILL" && failedTests === 0;
